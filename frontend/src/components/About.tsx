...
const About = ({ show, setShow }: IAboutProps) => {
  return show ? <main className="absolute top-0 bottom-0 left-0 right-0 bg-black z-50 p-8 flex justify-center">
    <article className="dark:prose-invert prose prose-p:text-left text-left">
      ...
      <p>I want to note that this project is quite dear to me and that it is different from my past projects. It is a love-hate relationship playing FGO (JP), some people even say it is masochistic, so being able to develop something based on the material I enjoy is special. And it is different than others in terms of my ambition and the scale of the project itself. An finally, I feel the urge to keep improving it.</p>
